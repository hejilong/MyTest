...
public final class GdtRegister {
	...
	public final void registerDownloadReceiver(Context context,final DownloadWatched watched){
		if (!hasRegister) {
			receiver = new DownloadReceiver(watched);
			YumiReceiverUtils.registerDownloadReceiver(context.getApplicationContext(), receiver);
			hasRegister = true;
		}
	}
