...
public final class XMLRendering {
	...
	private static final String MODEL_IMG_END = "</div></body></html>";
	...
	public static final String renderingImgTextXML(String icon, String title,
			String desc) {
		StringBuffer buffer = new StringBuffer("");
		if (NullCheckUtils.isNotNull(icon) && NullCheckUtils.isNotNull(title)
				&& NullCheckUtils.isNotNull(desc)) {
			buffer.append(MODEL_TEXTIMG);
			buffer.append(String
					.format(MODEL_TEXTIMG_APPEND, icon, title, desc));
